...
#AutoIt3Wrapper_Icon=..\MarkEditor\filesave_6362.ico
...
Func Button1()
	...
	ConsoleWrite('@@ Debug(' & @ScriptLineNumber & ') : ConsoleWrite("Button1"&@CRLF) = ' & ConsoleWrite("Button1"&@CRLF) & @CRLF & '>Error code: ' & @error & @CRLF) ;### Debug Console
